...
const en: PremiumPreviewCopy = {
  ...
  hero: {
    ...
    title: "Open Telegram and start practicing for the ADR exam",
    highlight: "in under a minute",
    text: "ADR Bot opens directly in Telegram, shows your first question right away, and lets you see how Basiskurs, Tank, and terminology work before you pay anything.",
    primary: "Open bot in Telegram",
    secondary: "See the 30-second preview",
    microNote: "One click. No sign-up. First question in under a minute.",
    trustPills: [
  ...
  faq: {
    ...
    ctaTitle: "Want to see the bot before you decide?",
    ctaDescription:
      "Open Telegram, get your first ADR question, and check the format before paying anything.",
    ctaButton: "Open the bot in Telegram",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
    imprint: "Imprint",
...
const ru: PremiumPreviewCopy = {
  ...
  hero: {
    ...
    title: "Открой Telegram и начни готовиться к ADR-экзамену",
    highlight: "меньше чем за минуту",
    text: "ADR Bot сразу откроется в Telegram, покажет первый вопрос и даст понять, подходит ли тебе формат Basiskurs, Tank и терминов еще до оплаты.",
    primary: "Открыть бота в Telegram",
    secondary: "Посмотреть 30-секундное превью",
    microNote: "Один клик. Без регистрации. Первый вопрос меньше чем за минуту.",
    trustPills: [
  ...
  faq: {
    ...
    ctaTitle: "Хочешь сначала посмотреть бота вживую?",
    ctaDescription:
      "Открой Telegram, получи первый ADR-вопрос и проверь формат еще до оплаты.",
    ctaButton: "Открыть бота в Telegram",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
    imprint: "Impressum",
...
const tr = buildLocalizedCopy("tr", {
  ...
  hero: {
    ...
    title: "Telegram'ı aç ve ADR sınavına çalışmaya başla",
    highlight: "Almanca",
    text: "ADR Bot doğrudan Telegram içinde açılır, ilk sorunu hemen gösterir ve ödeme yapmadan önce Basiskurs, Tank ve terim formatının sana uyup uymadığını görmeni sağlar.",
    primary: "Telegram botunu aç",
    secondary: "30 saniyelik önizlemeyi gör",
    microNote: "Tek tık. Kayıt yok. İlk soru bir dakikadan kısa sürede.",
    trustPills: [
  ...
  faq: {
    ...
    ctaTitle: "Önce botu canlı görmek ister misin?",
    ctaDescription:
      "Telegram'ı aç, ilk ADR sorunu gör ve ödeme yapmadan önce formatı kontrol et.",
    ctaButton: "Telegram botunu aç",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
...
const ar = buildLocalizedCopy("ar", {
  ...
  nav: {
    ...
    primary: "افتح البوت في Telegram",
  },
  hero: {
    eyebrow: "مرحلة اختبار عامة · نقرة واحدة إلى Telegram",
    title: "افتح Telegram وابدأ التدريب لامتحان ADR",
    highlight: "بالألمانية",
    text: "يفتح ADR Bot مباشرة داخل Telegram، ويعرض لك أول سؤال فورًا، ويجعلك ترى كيف يعمل Basiskurs وTank والمصطلحات قبل أن تدفع أي شيء.",
    primary: "افتح البوت في Telegram",
    secondary: "شاهد المعاينة خلال 30 ثانية",
    microNote: "نقرة واحدة. بلا تسجيل. أول سؤال خلال أقل من دقيقة.",
    trustPills: [
  ...
  faq: {
    ...
    ctaTitle: "هل تريد رؤية البوت أولًا قبل أن تقرر؟",
    ctaDescription:
      "افتح Telegram، واحصل على أول سؤال ADR، وتحقق من الأسلوب قبل أن تدفع أي شيء.",
    ctaButton: "افتح البوت في Telegram",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
...
const pl = buildLocalizedCopy("pl", {
  ...
  nav: {
    ...
    primary: "Otwórz bota w Telegramie",
  },
  hero: {
    eyebrow: "Publiczna faza testowa · jedno kliknięcie do Telegrama",
    title: "Otwórz Telegram i zacznij przygotowanie do egzaminu ADR",
    highlight: "po niemiecku",
    text: "ADR Bot otwiera się bezpośrednio w Telegramie, od razu pokazuje pierwsze pytanie i pozwala ocenić format Basiskurs, Tank i terminów jeszcze przed płatnością.",
    primary: "Otwórz bota w Telegramie",
    secondary: "Zobacz podgląd w 30 sekund",
    microNote: "Jedno kliknięcie. Bez rejestracji. Pierwsze pytanie w mniej niż minutę.",
    trustPills: [
  ...
  faq: {
    ...
    ctaTitle: "Chcesz najpierw zobaczyć bota na żywo?",
    ctaDescription: "Otwórz Telegram, zobacz pierwsze pytanie ADR i sprawdź format jeszcze przed płatnością.",
    ctaButton: "Otwórz bota w Telegramie",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
    imprint: "Nota prawna",
