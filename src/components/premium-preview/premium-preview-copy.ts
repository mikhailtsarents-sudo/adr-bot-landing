...
const en: PremiumPreviewCopy = {
  ...
  hero: {
    eyebrow: "Public test phase · one click to Telegram",
    title: "Get your first ADR questions in Telegram",
    highlight: "before you pay anything",
    text: "Open Telegram, type /start, and see real ADR questions in German in under a minute. Check Basiskurs, Tank, and terminology first, then decide whether full access is worth it.",
    primary: "Get first ADR questions in Telegram",
    secondary: "See how the bot works in 30 seconds",
    microNote: "Free start. No sign-up. First question in under 60 seconds.",
    trustPills: [
  ...
  pricing: {
    ...
    description:
      "Start free inside Telegram. Upgrade only if the format really helps you.",
    cards: [
      {
        title: "Free access",
        subtitle: "Open the bot, answer your first questions, and see if the format fits you.",
        price: "0 EUR",
        suffix: "/ free",
        features: [
          "See your first ADR question immediately",
          "See selected ADR terms",
          "Start directly in Telegram",
          "No extra learning platform",
        ],
        cta: "Open free in Telegram",
        source: "premium_preview_free",
      },
      {
        title: "Full access",
        subtitle:
          "One payment. Full ADR practice inside Telegram.",
        price: "15 EUR",
        suffix: "/ one-time",
        features: [
        ...
        cta: "Get full access in Telegram",
        source: "premium_preview_full_access",
        featured: true,
        badge: "Full Access",
      },
  ...
  faq: {
    ...
    ctaTitle: "Want to test the bot before paying?",
    ctaDescription:
      "Open Telegram, get your first ADR questions, and decide only after you see the format live.",
    ctaButton: "Get first ADR questions in Telegram",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
    imprint: "Imprint",
...
const ru: PremiumPreviewCopy = {
  ...
  nav: {
    ...
    primary: "Открыть бота в Telegram",
  },
  hero: {
    eyebrow: "Публичная тестовая фаза · один клик до Telegram",
    title: "Открой Telegram и получи первые ADR-вопросы",
    highlight: "до оплаты",
    text: "Открой Telegram, введи /start и уже через минуту увидишь реальные ADR-вопросы на немецком. Сначала проверь Basiskurs, Tank и термины, а потом решай, нужен ли полный доступ.",
    primary: "Получить первые ADR-вопросы в Telegram",
    secondary: "Посмотреть, как бот работает за 30 секунд",
    microNote: "Бесплатный старт. Без регистрации. Первый вопрос меньше чем за 60 секунд.",
    trustPills: [
  ...
  pricing: {
    ...
    description:
      "Сначала попробуй бесплатно в Telegram. Платить стоит только если формат реально заходит.",
    cards: [
      {
        title: "Бесплатный доступ",
        subtitle: "Чтобы открыть бота, ответить на первые вопросы и понять, подходит ли тебе такой формат.",
        price: "0 EUR",
        suffix: "/ бесплатно",
        features: [
          "Сразу увидеть первый вопрос ADR",
          "Посмотреть часть терминов",
          "Сразу стартовать в Telegram",
          "Без новой учебной платформы",
        ],
        cta: "Открыть бесплатно в Telegram",
        source: "premium_preview_free",
      },
      {
        title: "Полный доступ",
        subtitle:
          "Один платеж и полный ADR-тренажер прямо в Telegram.",
        price: "15 EUR",
        suffix: "/ один раз",
        features: [
        ...
        cta: "Получить полный доступ в Telegram",
        source: "premium_preview_full_access",
        featured: true,
        badge: "Full Access",
      },
  ...
  faq: {
    ...
    ctaTitle: "Хочешь сначала проверить бота вживую?",
    ctaDescription:
      "Открой Telegram, получи первые ADR-вопросы и решай только после того, как увидишь формат своими глазами.",
    ctaButton: "Получить первые ADR-вопросы в Telegram",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
    imprint: "Impressum",
...
const uk = buildLocalizedCopy("uk", {
  ...
  nav: {
    ...
    primary: "Відкрити бота в Telegram",
  },
  hero: {
    eyebrow: "Публічна тестова фаза · один клік до Telegram",
    title: "Відкрий Telegram і почни готуватися до іспиту ADR",
    highlight: "німецькою",
    text: "ADR Bot одразу відкривається в Telegram, показує перше запитання і дає змогу зрозуміти, чи підходить тобі формат Basiskurs, Tank і термінів ще до оплати.",
    primary: "Відкрити бота в Telegram",
    secondary: "Подивитися 30-секундне прев’ю",
    microNote: "Один клік. Без реєстрації. Перше запитання менш ніж за хвилину.",
    trustPills: [
  ...
  pricing: {
    ...
    description:
      "Спочатку спробуй безкоштовно в Telegram. Плати лише якщо формат справді допомагає.",
    cards: [
      {
        title: "Безкоштовний доступ",
        subtitle: "Щоб відкрити бота, відповісти на перші питання і зрозуміти, чи підходить тобі цей формат.",
        price: "0 EUR",
        suffix: "/ безкоштовно",
        features: [
          "Одразу побачити перше ADR-запитання",
          "Подивитися частину термінів",
          "Відразу стартувати в Telegram",
          "Без нової навчальної платформи",
        ],
        cta: "Відкрити безкоштовно в Telegram",
        source: "premium_preview_free",
      },
      {
        title: "Повний доступ",
        subtitle: "Один платіж і повне ADR-тренування прямо в Telegram.",
        price: "15 EUR",
        suffix: "/ один раз",
        features: [
        ...
        cta: "Отримати повний доступ у Telegram",
        source: "premium_preview_full_access",
        featured: true,
        badge: "Full Access",
      },
  ...
  faq: {
    ...
    ctaTitle: "Хочеш спочатку побачити бота наживо?",
    ctaDescription:
      "Відкрий Telegram, отримай перше ADR-запитання і перевір формат ще до оплати.",
    ctaButton: "Відкрити бота в Telegram",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
...
const tr = buildLocalizedCopy("tr", {
  ...
  nav: {
    ...
    primary: "Telegram'da ilk ADR sorularını aç",
  },
  hero: {
    eyebrow: "Herkese açık test aşaması · Telegram'a tek tık",
    title: "Telegram'da ilk ADR sorularını hemen gör",
    highlight: "ödeme yapmadan önce",
    text: "Telegram'ı aç, /start yaz ve bir dakikadan kısa sürede Almanca gerçek ADR sorularını gör. Önce Basiskurs, Tank ve terimleri dene, sonra tam erişime değip değmediğine karar ver.",
    primary: "Telegram'da ilk ADR sorularını aç",
    secondary: "Botun nasıl çalıştığını 30 saniyede gör",
    microNote: "Ücretsiz başlangıç. Kayıt yok. İlk soru 60 saniyeden kısa sürede.",
    trustPills: [
  ...
  pricing: {
    ...
    description:
      "Önce Telegram'da ücretsiz dene. Yalnızca format gerçekten işine yararsa yükselt.",
    cards: [
      {
        title: "Ücretsiz erişim",
        subtitle: "Botu açmak, ilk soruları cevaplamak ve formatın sana uyup uymadığını görmek için.",
        price: "0 EUR",
        suffix: "/ ücretsiz",
        features: [
          "İlk ADR sorunu hemen gör",
          "Seçili ADR terimlerini gör",
          "Doğrudan Telegram'da başla",
          "Ek öğrenme platformu yok",
        ],
        cta: "Telegram'da ücretsiz aç",
        source: "premium_preview_free",
      },
      {
        title: "Tam erişim",
        subtitle: "Tek ödeme ve tam ADR çalışması doğrudan Telegram'da.",
        price: "15 EUR",
        suffix: "/ tek sefer",
        features: [
        ...
        cta: "Tam erişimi Telegram'da al",
        source: "premium_preview_full_access",
        featured: true,
        badge: "Full Access",
      },
  ...
  faq: {
    ...
    ctaTitle: "Önce botu gerçek haliyle görmek ister misin?",
    ctaDescription:
      "Telegram'ı aç, ilk ADR sorularını gör ve formatı canlı görmeden ödeme yapma.",
    ctaButton: "Telegram'da ilk ADR sorularını aç",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
...
const ar = buildLocalizedCopy("ar", {
  ...
  nav: {
    ...
    primary: "افتح أول أسئلة ADR في Telegram",
  },
  hero: {
    eyebrow: "مرحلة اختبار عامة · نقرة واحدة إلى Telegram",
    title: "افتح Telegram وشاهد أول أسئلة ADR فورًا",
    highlight: "قبل أن تدفع أي شيء",
    text: "افتح Telegram، واكتب ‎/start‎، وخلال أقل من دقيقة سترى أسئلة ADR حقيقية بالألمانية. جرّب Basiskurs وTank والمصطلحات أولًا، ثم قرر إن كان الوصول الكامل يستحق ذلك.",
    primary: "افتح أول أسئلة ADR في Telegram",
    secondary: "شاهد كيف يعمل البوت خلال 30 ثانية",
    microNote: "بداية مجانية. بلا تسجيل. أول سؤال خلال أقل من 60 ثانية.",
    trustPills: [
  ...
  pricing: {
    ...
    description:
      "جرّب أولًا مجانًا داخل Telegram. ادفع فقط إذا كان هذا الأسلوب مناسبًا لك فعلًا.",
    cards: [
      {
        title: "وصول مجاني",
        subtitle: "لفتح البوت، والإجابة عن أول الأسئلة، ومعرفة ما إذا كان الأسلوب مناسبًا لك.",
        price: "0 EUR",
        suffix: "/ مجاني",
        features: [
          "شاهد أول سؤال ADR فورًا",
          "اطّلع على بعض مصطلحات ADR",
          "ابدأ مباشرة داخل Telegram",
          "من دون منصة تعليم إضافية",
        ],
        cta: "افتحه مجانًا في Telegram",
        source: "premium_preview_free",
      },
      {
        title: "وصول كامل",
        subtitle: "دفعة واحدة وتدريب ADR الكامل مباشرة داخل Telegram.",
        price: "15 EUR",
        suffix: "/ مرة واحدة",
        features: [
        ...
        cta: "احصل على الوصول الكامل في Telegram",
        source: "premium_preview_full_access",
        featured: true,
        badge: "Full Access",
      },
  ...
  faq: {
    ...
    ctaTitle: "هل تريد تجربة البوت بنفسك قبل الدفع؟",
    ctaDescription:
      "افتح Telegram، وشاهد أول أسئلة ADR، ثم قرر فقط بعد أن ترى الأسلوب مباشرة.",
    ctaButton: "افتح أول أسئلة ADR في Telegram",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
...
const pl = buildLocalizedCopy("pl", {
  ...
  nav: {
    ...
    primary: "Zobacz pierwsze pytania ADR w Telegramie",
  },
  hero: {
    eyebrow: "Publiczna faza testowa · jedno kliknięcie do Telegrama",
    title: "Otwórz Telegram i zobacz pierwsze pytania ADR",
    highlight: "zanim zapłacisz",
    text: "Otwórz Telegram, wpisz /start i w mniej niż minutę zobacz prawdziwe pytania ADR po niemiecku. Najpierw sprawdź Basiskurs, Tank i terminy, a dopiero potem zdecyduj o pełnym dostępie.",
    primary: "Zobacz pierwsze pytania ADR w Telegramie",
    secondary: "Zobacz, jak bot działa w 30 sekund",
    microNote: "Darmowy start. Bez rejestracji. Pierwsze pytanie w mniej niż 60 sekund.",
    trustPills: [
  ...
  pricing: {
    ...
    description: "Najpierw sprawdź bota za darmo w Telegramie. Płać dopiero wtedy, gdy taki format naprawdę Ci pomaga.",
    cards: [
      {
        title: "Dostęp bezpłatny",
        subtitle: "Aby otworzyć bota, odpowiedzieć na pierwsze pytania i sprawdzić, czy ten format Ci odpowiada.",
        price: "0 EUR",
        suffix: "/ gratis",
        features: [
          "Zobacz pierwsze pytanie ADR od razu",
          "Zobacz wybrane terminy ADR",
          "Zacznij od razu w Telegramie",
          "Bez dodatkowej platformy do nauki",
        ],
        cta: "Otwórz za darmo w Telegramie",
        source: "premium_preview_free",
      },
      {
        title: "Pełny dostęp",
        subtitle: "Jedna płatność i pełny trening ADR bez wychodzenia z Telegrama.",
        price: "15 EUR",
        suffix: "/ jednorazowo",
        features: [
        ...
        cta: "Uzyskaj pełny dostęp w Telegramie",
        source: "premium_preview_full_access",
        featured: true,
        badge: "Full Access",
      },
  ...
  faq: {
    ...
    ctaTitle: "Chcesz najpierw sprawdzić bota na żywo?",
    ctaDescription: "Otwórz Telegram, zobacz pierwsze pytania ADR i zdecyduj dopiero wtedy, gdy zobaczysz format w praktyce.",
    ctaButton: "Zobacz pierwsze pytania ADR w Telegramie",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
    imprint: "Nota prawna",
...
const ro = buildLocalizedCopy("ro", {
  ...
  nav: {
    ...
    primary: "Deschide botul în Telegram",
  },
  hero: {
    eyebrow: "Fază publică de test · un clic până la Telegram",
    title: "Deschide Telegram și începe pregătirea pentru examenul ADR",
    highlight: "în germană",
    text: "ADR Bot se deschide direct în Telegram, îți arată imediat prima întrebare și te lasă să vezi cum funcționează formatul Basiskurs, Tank și al termenilor înainte să plătești ceva.",
    primary: "Deschide botul în Telegram",
    secondary: "Vezi previzualizarea în 30 de secunde",
    microNote: "Un clic. Fără cont. Prima întrebare în mai puțin de un minut.",
    trustPills: [
  ...
  pricing: {
    ...
    description: "Testează mai întâi gratuit în Telegram. Plătești doar dacă formatul chiar te ajută.",
    cards: [
      {
        title: "Acces gratuit",
        subtitle: "Ca să deschizi botul, să răspunzi la primele întrebări și să vezi dacă acest format ți se potrivește.",
        price: "0 EUR",
        suffix: "/ gratuit",
        features: [
          "Vezi imediat prima întrebare ADR",
          "Vezi o parte din termenii ADR",
          "Începi direct în Telegram",
          "Fără platformă nouă de învățare",
        ],
        cta: "Deschide gratuit în Telegram",
        source: "premium_preview_free",
      },
      {
        title: "Acces complet",
        subtitle: "O singură plată și pregătire ADR completă direct în Telegram.",
        price: "15 EUR",
        ...
        cta: "Obține acces complet în Telegram",
        source: "premium_preview_full_access",
        featured: true,
        badge: "Full Access",
      },
  ...
  faq: {
    ...
    ctaTitle: "Vrei să vezi mai întâi botul pe viu?",
    ctaDescription: "Deschide Telegram, vezi prima întrebare ADR și verifică formatul înainte să plătești ceva.",
    ctaButton: "Deschide botul în Telegram",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
...
const bg = buildLocalizedCopy("bg", {
  ...
  nav: {
    ...
    primary: "Отвори бота в Telegram",
  },
  hero: {
    eyebrow: "Публична тестова фаза · един клик до Telegram",
    title: "Отвори Telegram и започни подготовката за ADR изпита",
    highlight: "на немски",
    text: "ADR Bot се отваря директно в Telegram, показва първия въпрос веднага и ти позволява да видиш как работят Basiskurs, Tank и термините още преди плащане.",
    primary: "Отвори бота в Telegram",
    secondary: "Виж 30-секундния преглед",
    microNote: "Един клик. Без регистрация. Първият въпрос идва за по-малко от минута.",
    trustPills: [
  ...
  pricing: {
    ...
    description: "Първо пробвай безплатно в Telegram. Плати само ако форматът наистина ти помага.",
    cards: [
      {
        title: "Безплатен достъп",
        subtitle: "За да отвориш бота, да отговориш на първите въпроси и да видиш дали този формат е за теб.",
        price: "0 EUR",
        suffix: "/ безплатно",
        features: [
          "Виж първия ADR въпрос веднага",
          "Виж избрани ADR термини",
          "Започни веднага в Telegram",
          "Без нова учебна платформа",
        ],
        cta: "Отвори безплатно в Telegram",
        source: "premium_preview_free",
      },
      {
        title: "Пълен достъп",
        subtitle: "Едно плащане и пълна ADR подготовка директно в Telegram.",
        price: "15 EUR",
        suffix: "/ еднократно",
        features: [
        ...
        cta: "Вземи пълен достъп в Telegram",
        source: "premium_preview_full_access",
        featured: true,
        badge: "Full Access",
      },
  ...
  faq: {
    ...
    ctaTitle: "Искаш ли първо да видиш бота на живо?",
    ctaDescription: "Отвори Telegram, виж първия ADR въпрос и провери формата преди да платиш.",
    ctaButton: "Отвори бота в Telegram",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
...
const hr = buildLocalizedCopy("hr", {
  ...
  nav: {
    ...
    primary: "Otvori bota u Telegramu",
  },
  hero: {
    eyebrow: "Javna testna faza · jedan klik do Telegrama",
    title: "Otvori Telegram i počni se pripremati za ADR ispit",
    highlight: "na njemačkom",
    text: "ADR Bot se otvara izravno u Telegramu, odmah pokazuje prvo pitanje i omogućuje ti da vidiš odgovara li ti format Basiskurs, Tank i pojmova prije nego što platiš.",
    primary: "Otvori bota u Telegramu",
    secondary: "Pogledaj pregled u 30 sekundi",
    microNote: "Jedan klik. Bez registracije. Prvo pitanje za manje od minute.",
    trustPills: [
  ...
  pricing: {
    ...
    description: "Najprije isprobaj besplatno u Telegramu. Plati tek ako ti format stvarno pomaže.",
    cards: [
      {
        title: "Besplatan pristup",
        subtitle: "Za otvaranje bota, odgovaranje na prva pitanja i provjeru odgovara li ti ovaj format.",
        price: "0 EUR",
        suffix: "/ besplatno",
        features: [
          "Odmah vidi prvo ADR pitanje",
          "Pogledaj odabrane ADR pojmove",
          "Počni odmah u Telegramu",
          "Bez nove platforme za učenje",
        ],
        cta: "Otvori besplatno u Telegramu",
        source: "premium_preview_free",
      },
      {
        title: "Puni pristup",
        subtitle: "Jedno plaćanje i puna ADR priprema izravno u Telegramu.",
        price: "15 EUR",
        suffix: "/ jednokratno",
        features: [
        ...
        cta: "Uzmi puni pristup u Telegramu",
        source: "premium_preview_full_access",
        featured: true,
        badge: "Full Access",
      },
  ...
  faq: {
    ...
    ctaTitle: "Želiš li najprije vidjeti bota uživo?",
    ctaDescription: "Otvori Telegram, pogledaj prvo ADR pitanje i provjeri format prije nego što platiš.",
    ctaButton: "Otvori bota u Telegramu",
  },
  footer: {
    copyright: "© 2026 ADR Bot",
