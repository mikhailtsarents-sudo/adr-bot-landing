...
export const translations: Record<LangCode, Translation> = {
  ...
  de: {
    ...
    hero: {
      ...
      offer: "Kostenlos starten: erste Fragen und Begriffe gratis. Full Access als einmalige Zahlung über 15 EUR.",
  ...
  en: {
    ...
    hero: {
      ...
      description: "Open Telegram, type /start, and see real ADR questions in German in under a minute. Check Basiskurs, Tank, and terminology first, then decide whether full access is worth it.",
      ctaPrimary: "Get first ADR questions in Telegram",
      ctaSecondary: "See how the bot works in 30 seconds",
      offer: "Start free: first questions and terms included. Full access is shown as a one-time 15 EUR payment.",
      note: "Free start. No sign-up. First question in under 60 seconds.",
    },
    problems: {
  ...
  ru: {
    ...
    hero: {
      ...
      description: "Открой Telegram, введи /start и уже через минуту увидишь реальные ADR-вопросы на немецком. Сначала проверь Basiskurs, Tank и термины, а потом решай, нужен ли полный доступ.",
      ctaPrimary: "Получить первые ADR-вопросы в Telegram",
      ctaSecondary: "Посмотреть, как бот работает за 30 секунд",
      note: "Бесплатный старт. Без регистрации. Первый вопрос меньше чем за 60 секунд.",
    },
    problems: {
  ...
  uk: {
    ...
    hero: {
      ...
      description: "ADR Bot одразу відкривається в Telegram, показує перше запитання і дає змогу зрозуміти, чи підходить тобі формат Basiskurs, Tank і термінів ще до оплати.",
      ctaPrimary: "Відкрити бота в Telegram",
      ctaSecondary: "Подивитися 30-секундне прев’ю",
      note: "Один клік. Без реєстрації. Перше запитання менш ніж за хвилину.",
    },
    problems: {
    ...
    cta: {
      ...
      button: "Відкрити бота в Telegram",
  ...
  tr: {
    ...
    hero: {
      ...
      description: "Telegram'ı aç, /start yaz ve bir dakikadan kısa sürede Almanca gerçek ADR sorularını gör. Önce Basiskurs, Tank ve terimleri dene, sonra tam erişime değip değmediğine karar ver.",
      ctaPrimary: "Telegram'da ilk ADR sorularını aç",
      ctaSecondary: "Botun nasıl çalıştığını 30 saniyede gör",
      note: "Ücretsiz başlangıç. Kayıt yok. İlk soru 60 saniyeden kısa sürede.",
    },
    problems: {
  ...
  ar: {
    ...
    hero: {
      ...
      description: "افتح Telegram، واكتب ‎/start‎، وخلال أقل من دقيقة سترى أسئلة ADR حقيقية بالألمانية. جرّب Basiskurs وTank والمصطلحات أولًا، ثم قرر إن كان الوصول الكامل يستحق ذلك.",
      ctaPrimary: "افتح أول أسئلة ADR في Telegram",
      ctaSecondary: "شاهد كيف يعمل البوت خلال 30 ثانية",
      note: "بداية مجانية. بلا تسجيل. أول سؤال خلال أقل من 60 ثانية.",
    },
    problems: {
  ...
  pl: {
    ...
    hero: {
      ...
      description: "Otwórz Telegram, wpisz /start i w mniej niż minutę zobacz prawdziwe pytania ADR po niemiecku. Najpierw sprawdź Basiskurs, Tank i terminy, a dopiero potem zdecyduj o pełnym dostępie.",
      ctaPrimary: "Zobacz pierwsze pytania ADR w Telegramie",
      ctaSecondary: "Zobacz, jak bot działa w 30 sekund",
      note: "Darmowy start. Bez rejestracji. Pierwsze pytanie w mniej niż 60 sekund.",
    },
    problems: {
    ...
    cta: {
      ...
      button: "Otwórz bota w Telegramie",
  ...
  ro: {
    ...
    hero: {
      ...
      description: "ADR Bot se deschide direct în Telegram, îți arată imediat prima întrebare și te lasă să vezi cum funcționează formatul Basiskurs, Tank și al termenilor înainte să plătești ceva.",
      ctaPrimary: "Deschide botul în Telegram",
      ctaSecondary: "Vezi previzualizarea în 30 de secunde",
      note: "Un clic. Fără cont. Prima întrebare în mai puțin de un minut.",
    },
    problems: {
    ...
    cta: {
      ...
      button: "Deschide botul în Telegram",
  ...
  bg: {
    ...
    hero: {
      ...
      description: "ADR Bot се отваря директно в Telegram, показва първия въпрос веднага и ти позволява да видиш как работят Basiskurs, Tank и термините още преди плащане.",
      ctaPrimary: "Отвори бота в Telegram",
      ctaSecondary: "Виж 30-секундния преглед",
      note: "Един клик. Без регистрация. Първият въпрос идва за по-малко от минута.",
    },
    problems: {
  ...
  hr: {
    ...
    hero: {
      ...
      description: "ADR Bot se otvara izravno u Telegramu, odmah pokazuje prvo pitanje i omogućuje ti da vidiš odgovara li ti format Basiskurs, Tank i pojmova prije nego što platiš.",
      ctaPrimary: "Otvori bota u Telegramu",
      ctaSecondary: "Pogledaj pregled u 30 sekundi",
      note: "Jedan klik. Bez registracije. Prvo pitanje za manje od minute.",
    },
    problems: {
    ...
    cta: {
      ...
      button: "Otvori bota u Telegramu",
