...
export const translations: Record<LangCode, Translation> = {
  ...
  en: {
    ...
    hero: {
      ...
      description: "ADR Bot opens directly in Telegram, shows your first question right away, and lets you see how Basiskurs, Tank, and terminology work before you pay anything.",
      ctaPrimary: "Open bot in Telegram",
      ctaSecondary: "See the 30-second preview",
      offer: "Start free: vocabulary trainer and 10 questions included. Full access from €15/month.",
      note: "One click. No sign-up. First question in under a minute.",
    },
    problems: {
  ...
  ru: {
    ...
    hero: {
      ...
      description: "ADR Bot сразу откроется в Telegram, покажет первый вопрос и даст понять, подходит ли тебе формат Basiskurs, Tank и терминов еще до оплаты.",
      ctaPrimary: "Открыть бота в Telegram",
      ctaSecondary: "Посмотреть 30-секундное превью",
      note: "Один клик. Без регистрации. Первый вопрос меньше чем за минуту.",
    },
    problems: {
  ...
  tr: {
    ...
    hero: {
      ...
      description: "ADR Bot doğrudan Telegram içinde açılır, ilk sorunu hemen gösterir ve ödeme yapmadan önce Basiskurs, Tank ve terim formatının sana uyup uymadığını görmeni sağlar.",
      ctaPrimary: "Telegram botunu aç",
      ctaSecondary: "30 saniyelik önizlemeyi gör",
      note: "Tek tık. Kayıt yok. İlk soru bir dakikadan kısa sürede.",
    },
    problems: {
  ...
  ar: {
    ...
    hero: {
      ...
      description: "يفتح ADR Bot مباشرة داخل Telegram، ويعرض لك أول سؤال فورًا، ويجعلك ترى كيف يعمل Basiskurs وTank والمصطلحات قبل أن تدفع أي شيء.",
      ctaPrimary: "افتح البوت في Telegram",
      ctaSecondary: "شاهد المعاينة خلال 30 ثانية",
      note: "نقرة واحدة. بلا تسجيل. أول سؤال خلال أقل من دقيقة.",
    },
    problems: {
  ...
  pl: {
    ...
    hero: {
      ...
      description: "ADR Bot otwiera się bezpośrednio w Telegramie, od razu pokazuje pierwsze pytanie i pozwala ocenić format Basiskurs, Tank i terminów jeszcze przed płatnością.",
      ctaPrimary: "Otwórz bota w Telegramie",
      ctaSecondary: "Zobacz podgląd w 30 sekund",
      note: "Jedno kliknięcie. Bez rejestracji. Pierwsze pytanie w mniej niż minutę.",
    },
    problems: {
